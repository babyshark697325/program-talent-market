    ...
    <div className="relative">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-32">
        <div className="text-center">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed font-medium mb-8 animate-fade-in pb-4" style={{ animationDelay: '0.4s' }}>
