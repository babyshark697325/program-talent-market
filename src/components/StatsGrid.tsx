    ...
    <div className="mb-8 md:mb-12 animate-fade-in">
      <div className="bg-gradient-to-r from-white/90 to-primary/10 backdrop-blur-sm rounded-2xl md:rounded-3xl p-6 md:p-12 shadow-xl border border-primary/20 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-extrabold mb-4 md:mb-6 bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent leading-[1.2] pb-2 md:pb-4 overflow-visible">
